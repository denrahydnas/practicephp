...
require("incs/phpmailer/class.phpmailer.php");    
...
if (!isset($error_message)){
    ...
    $mail->addAddress('s_harned@hotmail.com', 'Media Library');     // Add a recipient

    $mail->isHTML(false);                                  // Set email format to HTML

    $mail->Subject = 'Media Suggestion - ' . $name;
...
<?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
   echo "<p>Thanks for the email! I&rsquo;ll check out your suggestion shortly.</p>";
        ...
        <p>If you think there's something I&rsquo;m missing, please let me know! </br> Complete the form to send me an email.</p>
